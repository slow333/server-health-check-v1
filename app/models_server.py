...
from .models_users import BaseModel

class Server(BaseModel):
    server_name = db.Column(db.String(255), nullable=False, unique=True)
    server_ip = db.Column(db.String(40), nullable=False, unique=True)
    username = db.Column(db.String(100), nullable=False, default='root')
    password_hash = db.Column(db.String(255), nullable=False, default='1') # Consider encrypting this field
